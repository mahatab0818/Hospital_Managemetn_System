...
{
    public partial class Control_Doctor : Form
    {
        ...
        private void AddButton_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "insert into Doctortbl values('" + NameTextBox.Text + "','" + AddressTextBox.Text + "'," + contact + "," + age + ",'" + comboGender.Text + "','" + BloodGroupTextBox.Text + "')";
            cmd.ExecuteNonQuery();
            con.Close();
        ...
        private void Control_Doctor_Load(object sender, EventArgs e)
        {
            disp_data();
        }
        ...
        private void DeleteButton_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = con.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "delete from Doctortbl where name='" + NameTextBox.Text + "'";
            cmd.ExecuteNonQuery();
            con.Close();
        ...
        private void NameTextBox_TextChanged(object sender, EventArgs e)
        {
            if (NameTextBox.Text != "")
            {
                ...
                cmd.Connection = con;
                cmd.CommandText = "select * from Doctortbl where name= '" + NameTextBox.Text + "'";
                SqlDataAdapter DA = new SqlDataAdapter(cmd);
        ...
        private void UpdateButton_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = con.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "update Doctortbl set Address='" + AddressTextBox.Text + "',Contact_Number=" + contact + ",Age=" + age + ",Gender='" + comboGender.Text + "',[Blood Group]='" + BloodGroupTextBox.Text + "'where Name='" + NameTextBox.Text + "'";
            cmd.ExecuteNonQuery();
            con.Close();
